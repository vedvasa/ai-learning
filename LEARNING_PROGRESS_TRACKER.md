...
| 2 | Ticket Triage API | In progress |  |  | 101 deterministic tests; bounded retry and usage-recorder coverage | $0.00 | Typed structured output, validation, retries, and privacy-minimal usage telemetry |
