...
| 2 | Ticket Triage API | In progress |  |  | 123 deterministic tests; 30-case offline-validated evaluation set | $0.00 | Typed output, retries, privacy-minimal telemetry, and guarded batch evaluation |
